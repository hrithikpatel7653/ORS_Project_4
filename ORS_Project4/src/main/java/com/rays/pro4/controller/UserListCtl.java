...
public class UserListCtl extends BaseCtl{
	...
	protected void preload(HttpServletRequest request) {
		System.out.println("userList Ctl ki Preload chali");
		RoleModel rmodel = new RoleModel();
		System.out.println("Role Model ka Object Banaya");
		UserModel umodel = new UserModel();
		System.out.println("User Model Ka Object Banaya");
		try {
			List rlist = rmodel.list(0,0);
			System.out.println(rmodel +"___________role model");
			List ulist = umodel.list(0,0);
			System.out.println(umodel +"___________User model");
			
			
			request.setAttribute("RoleList", rlist);
			System.out.println(rlist +"___________request.set attribute se key value pair me set kiya ");
			request.setAttribute("LoginId", ulist);
			System.out.println(ulist +"___________request.set attribute se key value pair me set kiya ");
